...
<template>
  <section class="login__form__section">
    <div class="container">
      <img src="@/assets/Instabug.svg" alt="instabug icon" />
      <h2>Log in to Instabug</h2>
      <router-link to="/" class="login__btn google-btn">
        <img src="@/assets/google-icon.svg" alt="google icon" />
        <span>Google</span>
      </router-link>
      <router-link to="/" class="login__btn github-btn">
        <img src="@/assets/github-icon.png" alt="github icon" />
        <span>GitHub</span>
      </router-link>
      <router-link to="/" class="login__btn microsoft-btn">
      ...
      <p :v-if="errors.incorrect" :class="{ auth__error: errors.incorrect }">
        {{ errors.incorrect }}
      </p>

      <form class="form__wrapper" @submit="checkForm">
        ...
        <div class="input__container">
          <div>
            ...
            <router-link to="/" class="forgot__password">
              Forgot password?
            </router-link>
          </div>
          <input
            ...
            @change="passwordHandel"
            :class="{ error_msg: errors.passowrd }"
          />
          <p :v-if="errors.passowrd" class="error">
            {{ errors.passowrd }}
          </p>
        </div>
        <button type="submit" :disabled="isDisabled" id="submit_btn">
          Log in
        </button>
        <div class="register__link">
          ...
          <router-link to="/" class="signup"> Login via SSO </router-link>
        </div>
      </form>
      <div class="trusted__companies">
        <p>Trusted by the top companies.</p>
        <div class="companies_imgs__wrapper">
          <svg viewBox="0 0 39 28" id="shape-lyft-full-logo">
            <path
          ...
          <svg viewBox="0 0 79 14" id="shape-buzzfeed-full-logo">
            <path
          ...
          <svg viewBox="0 0 66 17" id="shape-asana-full-logo">
            <path
          ...
          <svg viewBox="0 0 214 74" id="shape-one-plus-logo">
            <path
...
export default {
  ...
  data() {
    return {
      errors: { email: "", passowrd: "", incorrect: "" },
      email: "",
      password: "",
      users: [
  ...
  methods: {
      ...
      if (this.email && this.password) {
        ...
        if (user) {
          if (user.password === this.password) {
            ...
            this.errors.incorrect = "Your email and/or password ar incorrect";
          }
        } else {
          this.errors.incorrect = "Your email and/or password ar incorrect";
        }
        ...
        this.errors.passowrd = "Password must be 6 Characters or more ";
      }
    },
    emailHandel: function (e) {
    ...
    passwordHandel: function (e) {
      if (this.email) {
        ...
        const passwordregx = /^(?=.*\d)(?=.*[A-Z])[0-9a-zA-Z]{8,}$/g;
        console.log("email name", emailName);

        if (passwordregx.test(e.target.value)) {
          // check if password contain username
          if (!e.target.value.includes(emailName)) {
            this.password = e.target.value;
            this.errors.passowrd = "";
          } else {
            this.errors.passowrd = "Enter Valid Password";
          }
        } else {
          this.errors.passowrd = "Password must be 6 Characters or more ";
        }
      } else {
        this.errors.passowrd = "Password must be 6 Characters or more test ";
      }
    },
  },
  computed: {
